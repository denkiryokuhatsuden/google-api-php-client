 ...
 * under the License.
 */
//require_once 'io/\GoogleApi\Io\CacheParser.php';
namespace GoogleApi\Test\IO;

use GoogleApi\Test\TestCase;

class ApiCacheParserTest extends TestCase
{
    public function testIsResponseCacheable ()
    {
        $config = new \GoogleApi\Config($this->loadParameters());
        
        $resp = new \GoogleApi\Io\HttpRequest('http://localhost', 'POST', array(), null, $config);
        $result = \GoogleApi\Io\CacheParser::isResponseCacheable($resp);
        $this->assertFalse($result);
        
        // The response has expired, and we don't have an etag for
        // revalidation.
        $resp = new \GoogleApi\Io\HttpRequest('http://localhost', 'GET', array(), null, $config);
        ...
        $resp = new \GoogleApi\Io\HttpRequest('http://localhost', 'HEAD', array(), null, $config);
        $resp->setResponseHttpCode('200');
        ...
        $resp = new \GoogleApi\Io\HttpRequest('GET', 'GET', array(), null, $config);
        $resp->setResponseHttpCode('200');
        $resp->setResponseHeaders(array(
            'Expires' => 'Wed, 11 Jan 2012 04:03:37 GMT',
            'Date' => 'Wed, 11 Jan 2012 04:03:37 GMT',
    ...
    public function testIsExpired ()
    {
        ...
        $this->assertFalse(\GoogleApi\Io\CacheParser::isExpired($resp));
        ...
        $this->assertTrue(\GoogleApi\Io\CacheParser::isExpired($resp));
    ...
    public function testMustRevalidate ()
    {
        ...
        // Expires 1 year in the future, and contains the must-revalidate
        // directive.
        ...
        $this->assertFalse(\GoogleApi\Io\CacheParser::mustRevalidate($resp));
        ...
        $this->assertTrue(\GoogleApi\Io\CacheParser::mustRevalidate($resp));
