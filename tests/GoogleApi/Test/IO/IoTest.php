...
class IoTest extends TestCase
{
    ...
    {
        $io = new \GoogleApi\Io\CurlIO($this->client);
        ...
        $rawResponse = \GoogleApi\Io\CurlIO::CONNECTION_ESTABLISHED .
                 "$rawHeaders\r\n$rawBody";
        list ($headers, $body) = $io->parseHttpResponse($rawResponse, $size);
    ...
    {
        $io = new \GoogleApi\Io\CurlIO($this->client);
        $req = new \GoogleApi\Io\HttpRequest(
            "http://localhost.com", 'GET', array(), null, $this->client->getConfig());
        ...
        $this->assertEquals(\GoogleApi\Io\CurlIO::FORM_URLENCODED, $req->getRequestHeader("content-type"));
    ...
    public function testCacheHit ()
    {
        ...
        $cacheReq = new \GoogleApi\Io\HttpRequest(
            "http://localhost.com", 'GET', array(), null, $this->client->getConfig());
        ...
        $res = $io->makeRequest(new \GoogleApi\Io\HttpRequest(
            "http://localhost.com", 'GET', array(), null, $this->client->getConfig()));
