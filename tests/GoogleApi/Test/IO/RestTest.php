...
class RestTest extends TestCase
{
    ...
    {
        $this->rest = new \GoogleApi\Io\REST();
    }
    ...
    public function testDecodeResponse ()
    {
        ...
        $response = new \GoogleApi\Io\HttpRequest($url, 'GET', array(), null, $config);
        ...
        foreach (array(200, 201) as $code) {
            ...
            $response = new \GoogleApi\Io\HttpRequest($url, 'GET', $headers, null, $config);
