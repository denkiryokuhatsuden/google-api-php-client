...
class ClientTest extends TestCase
{
    ...
    public function testPrepareService ()
    {
        ...
        $this->assertEquals(
            'https://accounts.google.com/o/oauth2/auth?response_type=code&redirect_uri=http%3A%2F%2Flocalhost%2F&client_id=test1&scope=http%3A%2F%2Ftest.com+scope2&access_type=&approval_prompt=', 
    ...
    public function testSettersGetters ()
    {
        ...
        $client->setAuthClass('GoogleApi\Auth\AuthNone');
        $client->setAuthClass('GoogleApi\Auth\OAuth2');

        try {
            $client->setAccessToken(null);
            die('Should have thrown an apiAuthException.');
        } catch(\GoogleApi\Auth\Exception $e) {
