...
/**
 * This class stores all the configuration information that is needed for
 * running an GoogleApi/Client.
 * Since this project was shifted to PSR-0 standard, Its required to stop using
...
class Config
{
    ...
    public function __construct ($config = array())
    {
        $this->apiConfig = array(
            ...
            // OAuth1 Settings.
            // If you're using the apiOAuth auth class, it will use these
            // values for the oauth consumer key and secret.
            // See
            ...
            // Site name to show in the Google's OAuth 1 authentication
            // screen.
            ...
            // If you want to run the test suite (by running # phpunit
            // AllTests.php in the tests/ directory), fill in the settings
            // below
            ...
            'oauth_test_user' => '', // and the user ID to use, this can
                                     // either be a vanity name 'testuser'
                                     // or a numberic ID '123456'
                                     
            // Don't change these unless you're working against a special
                                     // development or testing environment.
            'basePath' => 'https://www.googleapis.com',
            
            // IO Class dependent configuration, you only have to configure
            // the values for the class that was configured as the ioClass
            // above
            ...
            // Definition of service specific values like scopes,
            // oauth token URLs, etc
            'services' => array(
                'analytics' => array(
    ...
    /**
     * Returns the value of the wanted variable, If it doesn't exist $default
     * will be returned.
     *
     * @param $variable
     * @param null $default            
