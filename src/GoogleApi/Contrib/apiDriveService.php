...
class FilesServiceResource extends ServiceResource
{
    ...
    /**
     * Inserts a file, and any settable metadata or blob content sent with the
     * request.
     * (files.insert)
     *
     ...
     *            below.
     *            
     *            @opt_param bool updateViewedDate Whether to update the view
     *            date after successfully updating the file.
     *            @opt_param bool updateModifiedDate Controls updating the
     *            modified date of the file. If true, the modified date will be
     *            updated to the current time, regardless of whether other
     *            changes are being made. If false, the modified date will only
     *            be updated to the current time if other changes are also being
     *            made (changing the title, for example).
     *            @opt_param bool newRevision Whether a blob upload should
     *            create a new revision. If not set or false, the blob data in
     *            the current head revision will be replaced.
     * @return DriveFile
     */
     ...
     *            
     *            @opt_param bool updateViewedDate Whether to update the view
     *            date after successfully retrieving the file.
     *            @opt_param string projection Restrict information returned for
 ...
 * <a href="https://developers.google.com/drive/" target="_blank">API
 * Documentation</a>
 * </p>
 *
 * @author Google, Inc.
...
class DriveFile extends Model
{
    ...
    {
        $this->assertIsArray($parentsCollection, 'DriveFileParentsCollection', 
                __METHOD__);
