...
class UrlchannelsServiceResource extends ServiceResource
{
    ...
    /**
     * List all host URL channels in this AdSense account.
     * (urlchannels.list)
     *
 ...
 * <a href="https://code.google.com/apis/adsense/host/" target="_blank">API
 * Documentation</a>
 * </p>
 *
 * @author Google, Inc.
...
class apiAdsensehostService extends Service
{
    ...
    public function __construct (Client $Client)
    {
        ...
        $this->urlchannels = new UrlchannelsServiceResource($this, 
                ...
                json_decode(
                        '{"methods": {"list": {"parameters": {"pageToken": {"type": "string", "location": "query"}, "adClientId": {"required": true, "type": "string", "location": "path"}, "maxResults": {"format": "int32", "maximum": "10000", "minimum": "0", "location": "query", "type": "integer"}}, "id": "adsensehost.urlchannels.list", "httpMethod": "GET", "path": "adclients/{adClientId}/urlchannels", "response": {"$ref": "UrlChannels"}}}}', 
                        true));
        $this->adclients = new AdclientsServiceResource($this, 
                $this->serviceName, 'adclients', 
                json_decode(
                        '{"methods": {"list": {"parameters": {"pageToken": {"type": "string", "location": "query"}, "maxResults": {"format": "int32", "maximum": "10000", "minimum": "0", "location": "query", "type": "integer"}}, "id": "adsensehost.adclients.list", "httpMethod": "GET", "path": "adclients", "response": {"$ref": "AdClients"}}}}', 
                        true));
        ...
        $this->customchannels = new CustomchannelsServiceResource($this, 
                ...
                json_decode(
                        '{"methods": {"list": {"parameters": {"pageToken": {"type": "string", "location": "query"}, "adClientId": {"required": true, "type": "string", "location": "path"}, "maxResults": {"format": "int32", "maximum": "10000", "minimum": "0", "location": "query", "type": "integer"}}, "id": "adsensehost.customchannels.list", "httpMethod": "GET", "path": "adclients/{adClientId}/customchannels", "response": {"$ref": "CustomChannels"}}}}', 
                        true));
    }
}
...
class AdsensehostReportsGenerateResponse extends Model
{
    ...
    public function setHeaders(/* array(AdsensehostReportsGenerateResponseHeaders) */ $headers)
    {
        $this->assertIsArray($headers, 
                'AdsensehostReportsGenerateResponseHeaders', __METHOD__);
