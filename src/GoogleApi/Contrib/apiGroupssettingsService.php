...
class GroupsServiceResource extends ServiceResource
{
     ...
     * @return Groups
     */
    public function patch ($groupUniqueId, Groups $postBody, 
            $optParams = array())
    {
        $params = array(
     ...
     * @return Groups
     */
    public function update ($groupUniqueId, Groups $postBody, 
            $optParams = array())
    {
        $params = array(
                'groupUniqueId' => $groupUniqueId,
...
class Groups extends Model
{
    ...
    public function setDefaultMessageDenyNotificationText (
