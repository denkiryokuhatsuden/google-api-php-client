...
class CreativesServiceResource extends ServiceResource
{
     ...
     * @return Creative
     */
    public function get ($accountId, $buyerCreativeId, $adgroupId, 
            $optParams = array())
    {
        $params = array(
                'accountId' => $accountId,
 ...
 * <a href="https://developers.google.com/ad-exchange/buyer-rest"
...
class Account extends Model
{
    ...
    {
        $this->assertIsArray($bidderLocation, 'AccountBidderLocation', 
                __METHOD__);
